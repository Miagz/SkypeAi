...
class SkypeGroupChat(SkypeChat):
    ...
    def addMember(self, id, admin=False):
        ...
        """
        self.skype.conn("PUT", "{0}/threads/{1}/members/28:{2}".format(self.skype.conn.msgsHost, self.id, id),
    ...
    def removeMember(self, id):
        ...
        """
        self.skype.conn("DELETE", "{0}/threads/{1}/members/{2}".format(self.skype.conn.msgsHost, self.id, id),
                        auth=SkypeConnection.Auth.RegToken)
